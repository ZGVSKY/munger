    ...
    return coroutine.create(function()
        ...
        for x = 1, widthCells do
            for y = 1, heightCells do
                ...
                -- Малюємо тільки сушу/річки (вода вже є фоном)
                if cell.height >= 0.3 or cell.isRiver or cell.isLake then
                    ...
                    -- Фарбуємо
                    if cell.isLake then rect:setFillColor(0, 0.3, 0.8)
                    elseif cell.isRiver then rect:setFillColor(0, 0.4, 1.0)
                    ...
                    -- ВАЖЛИВО: Одразу видаляємо об'єкт.
                    -- Solar2D встигне поставити його в чергу на малювання в текстуру,
                    -- але пам'ять звільниться.
                    --rect:removeSelf()
                end
